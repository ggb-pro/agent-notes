...
public class DirectAPIService {
    public String processUserQuery(String query, List<String> conversationHistory) {
        // 手动拼接历史对话
...
// 传统文档检索方式
```java
public class TraditionalDocumentSearch {
...
// LangChain方式的智能问答
public class LangChainDocumentQA {
    private VectorStore vectorStore;
    private ConversationalRetrievalChain qaChain;
