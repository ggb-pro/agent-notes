...
public class AnalysisState {
    // 业务数据层
    private List<UserEvent> rawData;
    private List<UserEvent> cleanedData;
    private AnalysisResult statisticsResult;
...
```java
private AnalysisState cleanDataNode(AnalysisState state) {
    try {
...
```java
private AnalysisState processLargeDataset(AnalysisState state) {
